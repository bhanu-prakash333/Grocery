...
const AddProduct = () => {
  ...
  return (
     <div className="no-scrollbar flex-1 min-h-screen overflow-y-scroll  flex flex-col justify-between">
            <form onSubmit={onSubmitHandler} className="md:p-10 p-4 space-y-5 max-w-lg">
                ...
                <button className=" cursor-pointer px-8 py-2.5 bg-[#4fbf8b] text-white font-medium rounded">ADD</button>
            </form>
        </div>
  )
}
