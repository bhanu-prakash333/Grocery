...
const Cart = () => {
    const {axios,products,setCartItems,currency, cartItems, removeFromCart, getCartCount, updateCartItem, getCartAmount ,navigate, user} = UseAppContext()
        ...
        try {
            ...
            if(data.success){
                ...
                if(data.addresses.length > 0){
                   ...
                   toast("No addresses saved yet.", { icon: "ℹ️" });
                }
            }
        } catch (error) {
        ...
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                <h1 className="text-3xl font-medium mb-6">
                    Shopping Cart <span className="text-sm text-[#4fbf8b]">{getCartCount()}</span>
                </h1>
